...
final class backAnalyseController extends AbstractController
{
    ...
    #[Route('/search/{dossierId}', name: 'app_back_analyse_search', methods: ['GET'])]
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_back_analyse_index', ['dossierId' => $analyse->getDossier()->getId()], Response::HTTP_SEE_OTHER);
        }
