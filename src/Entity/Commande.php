...
class Commande
{
    ...
    #[Assert\Choice(choices: ["aucun","En cours", "Expédiée", "Livrée", "Annulée"], message: "Le statut doit être 'En cours', 'Expédiée', 'Livrée' ou 'Annulée'.")]
    private ?string $statut = null;

    /**
 * @var Collection<int, Produit>
 */
#[ORM\OneToMany(targetEntity: Produit::class, mappedBy: 'commande', cascade: ['persist'], orphanRemoval: false)]
