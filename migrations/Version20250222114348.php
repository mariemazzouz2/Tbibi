...
final class Version20250222114348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE analyse (id INT AUTO_INCREMENT NOT NULL, dossier_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, dateanalyse DATE NOT NULL, donneesAnalyse
 VARCHAR(255) NOT NULL, diagnostic VARCHAR(255) NOT NULL, INDEX IDX_351B0C7E611C0C56 (dossier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
